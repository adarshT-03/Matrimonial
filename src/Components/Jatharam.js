...
export default class Jatharam extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data1: [],
    ...
    fetch("http://localhost:3000/single-users-details", {
      ...
      .then((data) => {
        this.setState(
          ...
          function () {
            console.log(this.state.data1, "jatahram");
          }
        );
      });
  };
  ...
  render() {
    ...
    return (
      <div>
        {this.state.data1.map((details, index) => {
          return (
            <div>
              <div className="mb5">
                ...
                <div className="divToPrint2">
                  ...
                  <div className="row">
                    ...
                    <div className="pdf-btm">
                      <div>
                        Note: Our company operates with the help of the Kongu
                        Wedding Organizers team. After the marriage is
                        confirmed, the service charge will be Rs.500 / -
                        (minimum (25000) for the female horoscope and Rs.1000 /
                        - for the male horoscope (minimum (50000)) separately.
                        Registration Date: 2021-09-24 00:00:00, Print Date:
                        11-10-2021
                      </div>
...
Jatharam.contextType = UserContext;
